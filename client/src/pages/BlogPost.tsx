...
const blogPosts = [
  {
    ...
    content: `
      ...
      <img src="https://d2xsxph8kpxj0f.cloudfront.net/310419663029768615/JcjScaA3JMvUY4j8iKMkae/REVorganicblogpostcoverphoto_ad36da8c.webp" alt="Earthy Organic Style Mood Board" class="w-full h-auto rounded-lg shadow-md my-8" />
